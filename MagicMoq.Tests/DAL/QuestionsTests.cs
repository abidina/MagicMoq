...
namespace MagicMoq.Tests.DAL
{
    ...
    public class QuestionsTests
    {
        ...
        public void EnsureSayHelloReturnsHelloWorld()
        {
            ...
            mock_answers.Setup(a => a.HelloWorld()).Returns("Hello World"); //says "look for calls to HelloWorld();" & tells it what to return, how to hijack the method call
            
            // Add code that mocks the "HelloWorld" method response

            Questions questions = new Questions(mock_answers.Object); //inject the "fake" answers instance into Questions constructors
